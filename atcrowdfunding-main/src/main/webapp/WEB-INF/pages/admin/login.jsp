...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" role="form" method="post" action="${ PATH }/admin/doLogin">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 用户登录</h2>
		  <div class="form-group has-success has-feedback">
		  	<span style="color:red;">${ errorMsg }</span>
			<input type="text" name="loginacct" class="form-control" value="${ requestScope.loginAcct }" id="inputSuccess4" placeholder="请输入登录账号" autofocus>
  ...
  <%@ include file="/WEB-INF/pages/include/base_js.jsp" %>
    ...
    function dologin() {
        ...
        if ( type == "user" ) {
           // window.location.href = "/admin/doLogin";
           //提交表单
           $("form").submit();
        } else if ( type == "member" ){
